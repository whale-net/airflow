...
with DAG(dag_id='yar_be_the_dag', start_date=datetime(2024, 1, 27), schedule="* * * * *") as dag:
    ...
    divergent_1 = sample_python_task_2() >> [sample_python_task_3(), sample_python_task_4(), sample_python_task_5()] >> sample_python_task_6() >> sample_python_task_7()

    divergent_2 = [sample_python_task_3(), sample_python_task_4(), intro_chain] >> sample_python_task_8()
